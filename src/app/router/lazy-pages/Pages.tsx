...
export const Pages = {
  ...
  ExpenceList: lazy(() => import("@/pages/admin/expence-list")),
  IncomeList: lazy(() => import("@/pages/admin/income-list")),
  AddIncome: lazy(() => import("@/pages/admin/income-add")),
  UpdateIncome: lazy(() => import("@/pages/admin/income-update")),
  IncomeCategoryList: lazy(() => import("@/pages/admin/income-category-list")),
  IncomeSummary: lazy(() => import("@/pages/admin/income-summary")), 
  LoanList: lazy(() => import("@/pages/admin/loan-list")),
  LoanAdd: lazy(() => import("@/pages/admin/loan-add")),
  LoanRepay: lazy(() => import("@/pages/admin/loan-repay")),
  LoanDetail: lazy(() => import("@/pages/admin/loan-detail")),
  LoanRepaymentHistory: lazy(() => import("@/pages/admin/loan-repayment-history")),
  ExpenseSummary: lazy(() => import("@/pages/admin/expence-summery")),
  ExpenseCategory: lazy(() => import("@/pages/admin/expence-category")),
  AddExpense: lazy(() => import("@/pages/admin/expence-add")),
  UpdateExpense: lazy(() => import("@/pages/admin/expence-update")),
  ...
  FinancialSummaryWidget: lazy(() => import("@/pages/admin/financial-summary-widget")),
  OpeningBalance: lazy(() => import("@/pages/admin/opening-balance")),
  ManualEntry: lazy(() => import("@/pages/admin/cashledger-manual-entry")),
  CashBalanceDashboard: lazy(() => import("@/pages/admin/cash-balance-dashboard")),
  CashLedgerHistory: lazy(() => import("@/pages/admin/cashledger-history")),
