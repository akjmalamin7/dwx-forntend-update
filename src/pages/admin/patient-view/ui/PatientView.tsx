                ...
                <div className="flex flex-col md:flex-row gap-6 mb-6">
                  ...
                  <div className="md:w-1/2 w-full">
                    <div className="border border-gray-300 rounded-md p-4">
                      <h2 className="text-sm font-semibold text-gray-700 mb-2">Selected Doctor List</h2>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-y-2 gap-x-2">

                        <label key="" className="flex items-center space-x-1">
                          <input type="checkbox" name="selected_drs_id" value="10" className="form-checkbox"  />
                          Dr. Manik
                        </label>
                        <label key="" className="flex items-center space-x-1">
                          <input type="checkbox" name="selected_drs_id" value="10" className="form-checkbox"  />
                  ...
                  <div className="md:w-1/2 w-full">
                    <div className="border border-gray-300 rounded-md p-4">
                      <h2 className="text-sm font-semibold text-gray-700 mb-2">Ignored Doctor List</h2>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-y-2 gap-x-2">

                      <label key="" className="flex items-center space-x-1">
                        <input type="checkbox" name="ignored_drs_id" className="form-checkbox"  />
                          Dr. Mahfuj
                      </label>
                      <label key="" className="flex items-center space-x-1">
                        <input type="checkbox" name="selected_drs_id" value="10" className="form-checkbox"  />
