      ...
      <div className="p-4">
        <form 
         ...
         className="grid grid-cols-12 gap-y-4 items-center">
          ...
          <div className="col-span-9">
            <Input size="sm" placeholder="Patient Id" />
          </div>
          ...
          <div className="col-span-9">
            <Input size="sm" placeholder="Patient name" />
          </div>
          ...
          <div className="col-span-9">
            <Input size="sm" placeholder="Patient Age" />
          </div>
          ...
          <div className="col-span-9 grid grid-cols-2 gap-2">
            <Input size="sm" placeholder="X-ray Name" />
            <select className="border border-neutral-400 rounded w-full p-2">
              <option>Choose x-ray name</option>
