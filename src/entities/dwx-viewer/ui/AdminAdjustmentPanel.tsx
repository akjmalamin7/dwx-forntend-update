...
const AdminAdjustmentPanel = ({
  ...
  return (
    ...
    <div className=" overflow-y-auto ">
       <div className="grid grid-cols-6 gap-2 items-center overflow-y-auto">
        {/* Blur */}
        <Input
          label="Blur"
          type="range"
        ...
        <Input
          ...
          onChange={(e) => handleAdjustmentChange("invert", Number(e.target.value))}
          className="h-auto!"
        />
...
export default AdminAdjustmentPanel;
