    ...
    <div className="max-w-[300px] mx-auto mt-10">
      <form onSubmit={handleSubmit(onSubmit)} >
        <div className="flex flex-col gap-4">
          <div>
            <Input size="sm" {...register("email")} type="text" placeholder="Username" />
            {errors.email && (
          ...
          <div>
            <Input size="sm" {...register("password")} type="password" placeholder="Your password" />
            {errors.password && (
              <Text size="sm" className="text-red-500">
          ...
          <Button loading={isLoading} disabled={!isValid} color="dark" size="size-2" width="full" type="submit">
